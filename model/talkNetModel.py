...
class talkNetModel(nn.Module):
    def __init__(self, positional_emb_flag):
        ...
        self.crossA2V = attentionLayer(d_model = 128, nhead = 8, positional_emb_flag=positional_emb_flag)
        self.crossV2A = attentionLayer(d_model = 128, nhead = 8, positional_emb_flag=positional_emb_flag)

        # Audio-visual Self Attention
        self.selfAV = attentionLayer(d_model = 256, nhead = 8, positional_emb_flag=positional_emb_flag)
